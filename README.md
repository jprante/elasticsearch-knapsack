...
## Installation 2.x
    ...
    ./bin/plugin install http://xbib.org/repository/org/xbib/elasticsearch/plugin/elasticsearch-knapsack/2.3.5.0/elasticsearch-knapsack-2.3.5.0-plugin.zip
