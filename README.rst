...
1.0.0.RC1      1.0.0.RC1.1        Jan 16, 2013       ./bin/plugin --install knapsack --url http://bit.ly/19vmQHu
1.0.0.RC1      1.0.0.RC1.1 (S3)   Jan 16, 2013       ./bin/plugin --install knapsack --url http://bit.ly/1m82PHw
=============  =================  =================  ===========================================================
