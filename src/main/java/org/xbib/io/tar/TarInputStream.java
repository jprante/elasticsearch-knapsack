...
class TarInputStream extends FilterInputStream {
    ...
    /**
     * Construct a TarInputStream using specified input stream and default block
     * and record sizes.
     *
    ...
    /**
     * Construct a TarInputStream using specified input stream, block size and
     ...
     * @exception IOException when an IO error causes operation to fail
     */
    private void skip(final int numToSkip) throws IOException {
        // REVIEW
