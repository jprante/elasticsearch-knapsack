...
public class TarArchiveOutputStream extends ArchiveOutputStream<TarArchiveEntry> {
    ...
    public TarArchiveOutputStream(OutputStream out) {
        this(out, TarBuffer.DEFAULT_BLKSIZE, TarBuffer.DEFAULT_RCDSIZE);
    }
    ...
    public TarArchiveOutputStream(OutputStream out,
                                  int blockSize) {
        this(out, blockSize, TarBuffer.DEFAULT_RCDSIZE);
    }
     ...
     */
    public TarArchiveOutputStream(OutputStream out,
                                  int blockSize, String encoding) {
        this(out, blockSize, TarBuffer.DEFAULT_RCDSIZE, encoding);
    }
    ...
    public TarArchiveOutputStream(OutputStream out,
        ...
        this(out, blockSize, recordSize, null);
    }
     ...
     */
    public TarArchiveOutputStream(OutputStream out,
                                  int blockSize, int recordSize, String encoding) {
        this.out = out;
    ...
    public void write(byte[] wBuf, int wOffset, int numToWrite) throws IOException {
        ...
        getWatcher().updateBytesTransferred(numToWrite);
    }
