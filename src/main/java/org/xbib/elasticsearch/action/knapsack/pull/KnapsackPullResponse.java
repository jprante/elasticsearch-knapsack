...
public class KnapsackPullResponse extends ActionResponse implements ToXContent {
    ...
    public KnapsackPullResponse setState(KnapsackState state) {
        this.state = state;
        return this;
    }
    ...
    public KnapsackPullResponse setRunning(boolean running) {
