...
public class KnapsackExportResponse extends ActionResponse implements ToXContent {
    ...
    public KnapsackExportResponse setState(KnapsackState state) {
        this.state = state;
        return this;
    }
    ...
    public KnapsackExportResponse setRunning(boolean running) {
    ...
    public KnapsackExportResponse setReason(String reason) {
        this.reason = reason;
        return this;
    }
