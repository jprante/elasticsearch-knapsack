...
public class KnapsackImportRequest extends SingleCustomOperationRequest
    ...
    public KnapsackImportRequest setPort(int port) {
        this.port = port;
        return this;
    }
    ...
    public KnapsackImportRequest setCluster(String cluster) {
    ...
    public KnapsackImportRequest setSniff(boolean sniff) {
        this.sniff = sniff;
        return this;
    }
    ...
    public KnapsackImportRequest setIndex(String index) {
        this.index = index;
        return this;
    }
    ...
    public KnapsackImportRequest setType(String type) {
        this.type = type;
        return this;
    }
    ...
    public KnapsackImportRequest setTimeout(TimeValue timeValue) {
    ...
    public KnapsackImportRequest setMaxActionsPerBulkRequest(int maxActionsPerBulkRequest) {
    ...
    public KnapsackImportRequest setMaxBulkConcurrency(int maxBulkConcurrency) {
    ...
    public KnapsackImportRequest addIndexSettings(String index, String settingsSpec) {
        indexTypeDefinitions.put(index, settingsSpec);
        return this;
    }

    public KnapsackImportRequest addIndexTypeMapping(String indexType, String mappingSpec) {
    ...
    public KnapsackImportRequest setSearchRequest(SearchRequest searchRequest) {
    ...
    public KnapsackImportRequest withMetadata(boolean withMetadata) {
