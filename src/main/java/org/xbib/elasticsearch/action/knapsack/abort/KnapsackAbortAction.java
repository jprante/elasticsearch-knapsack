...
public class KnapsackAbortAction extends Action<KnapsackAbortRequest, KnapsackAbortResponse, KnapsackAbortRequestBuilder> {
    ...
    public final static KnapsackAbortAction INSTANCE = new KnapsackAbortAction(NAME);

    protected KnapsackAbortAction(String name) {
        super(name);
    }

    @Override
    public KnapsackAbortResponse newResponse() {
        return new KnapsackAbortResponse();
    }
